...
type OrderItem struct {
	ID          string    `json:"id"`                        // Unique identifier for the order item
	OrderID     string    `json:"orderId"`                   // Foreign key to associate with the order
	ProductID   string    `json:"productId"`                 // Foreign key to associate with the product
